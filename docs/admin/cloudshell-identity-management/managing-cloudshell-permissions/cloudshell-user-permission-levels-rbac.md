...
For more information about group roles and access levels, see [Managing CloudShell Groups](../../../admin/cloudshell-identity-management/managing-users/managing-cloudshell-groups.md).
:::note
In the tables below, "View Only access" indicates the permissible actions for users who are members of a group that is defined as **View Only** in the domain. For more information, see [Associating groups with a domain](../../../admin/cloudshell-identity-management/managing-users/managing-cloudshell-groups.md#associating-groups-with-a-domain).
:::
## Blueprints
